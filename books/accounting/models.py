...
class Account(models.Model):
    ...
    System accounts (is_system=True) are reserved for the 3 Equity rows
    seeded by `seed_default_coa`: they cannot be deactivated, deleted
    (via reset_coa), or have is_system flipped post-create.
    """
